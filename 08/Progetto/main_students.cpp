...
void init_reflective_sphere() {
	...
	obj.M = glm::scale(glm::translate(glm::mat4(1), glm::vec3(-5, 2, -5)), glm::vec3(2.0));
...
void init_rock() {
	...
	obj.shading = ShadingType::NORMAL_MAPPING; // TODO NORMAL_MAPPING;
	obj.name = "Sharpy Rock";
	obj.M = glm::scale(glm::translate(glm::mat4(1), glm::vec3(5, 0.75, 5)), glm::vec3(0.05));
	objects.push_back(obj);
}
...
void init_brick_column() {
	...
	obj.M = glm::scale(glm::translate(glm::mat4(1), glm::vec3(6, 2, -3)), glm::vec3(10.));
	objects.push_back(obj);
}
...
void init_skybox() {
	...
	obj.name = "skybox";
	obj.M = glm::scale(glm::translate(glm::mat4(1), glm::vec3(0, 0, 0)), glm::vec3(1000.));
	objects.push_back(obj);
}
...
void init_torus() {
	...
	obj.mesh = torus;
	obj.material = MaterialType::NO_MATERIAL;
	obj.shading = ShadingType::PASS_THROUGH; // TEXTURE_ONLY;  
	obj.name = "Torus";
...
void init() {
	...
	shaders_IDs[NORMAL_MAPPING] = initShader(ShaderDir + "v_normal_map.glsl", ShaderDir + "f_normal_map.glsl");
	...
	shaders_IDs[SKYBOX] = initShader(ShaderDir + "v_skybox.glsl", ShaderDir + "f_skybox.glsl");
	//Otteniamo i puntatori alle variabili uniform per poterle utilizzare in seguito
	...
	shaders_IDs[REFLECTION] = initShader(ShaderDir + "v_reflection.glsl", ShaderDir + "f_reflection.glsl");
	//Otteniamo i puntatori alle variabili uniform per poterle utilizzare in seguito
	...
	shaders_IDs[REFRACTION] = initShader(ShaderDir + "v_refraction.glsl", ShaderDir + "f_refraction.glsl");
	base_unif = {};
	//Otteniamo i puntatori alle variabili uniform per poterle utilizzare in seguito
